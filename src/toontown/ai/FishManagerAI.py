...
from toontown.toonbase.HolidayGlobals import JELLYBEAN_FISHING_HOLIDAY, JELLYBEAN_FISHING_HOLIDAY_MONTH
...
class FishManagerAI:
    ...
    def creditFishTank(self, av):
        ...
        if simbase.air.holidayManager.areHolidaysRunning([JELLYBEAN_FISHING_HOLIDAY, JELLYBEAN_FISHING_HOLIDAY_MONTH]):
            value *= 2
        av.addMoney(value)
        av.b_setFishTank([], [], [])
