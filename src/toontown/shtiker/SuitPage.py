...
class SuitPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.paintRadarButton = DirectButton(parent=self.iconNode, relief=None, state=DGG.DISABLED, image=(icon, icon, icon), image_scale=(0.03375, 1, 0.045), image2_color=Vec4(1.0, 1.0, 1.0, 0.75), pos=(-0.2, 10, -0.615), command=self.toggleRadar, extraArgs=[4])
        self.radarButtons.append(self.paintRadarButton)
