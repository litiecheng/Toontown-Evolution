...
paintPolyColor = VBase4(0.70, 0.80, 0.90, 1.0)
suitsPerLevel = [1,
 1,
 1,
 1,
...
def getRandomSuitByLevel(level):
    deptNumber = random.randint(0, 3)
    return suitHeadTypes[suitsPerDept * deptNumber + level]
