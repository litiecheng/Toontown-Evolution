...
class LocalToon(DistributedToon.DistributedToon, LocalAvatar.LocalAvatar):
    ...
    def loadGardeningGui(self):
        ...
        self.__gardeningGui = DirectFrame(parent=base.a2dTopLeft,
            relief=None, geom=gardenGuiCard, geom_color=GlobalDialogColor,
            geom_scale=(0.17, 1.0, 0.3), pos=(0.15, 0, -0.6), scale=1.0)
        self.__gardeningGui.setName('gardeningFrame')

        self.__gardeningGuiFake = DirectFrame(parent=base.a2dTopLeft,
            relief=None, geom=None, geom_color=GlobalDialogColor,
            geom_scale=(0.17, 1.0, 0.3), pos=(0.15, 0, -0.6), scale=1.0)
