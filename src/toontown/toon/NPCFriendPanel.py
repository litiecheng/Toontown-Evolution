...
class NPCFriendCard(DirectFrame):
    ...
    def __handleDeleteNPCFriend(self):
        npcId = self['NPCID']
        npcName = TTLocalizer.NPCToonNames[npcId]
    ...
    def __deleteNPCFriend(self):
        ...
        base.localAvatar.sendUpdate('attemptDeleteNPCFriend', [npcId])
        self.front.hide()
        self.back.show()
