...
QuestDialogDict = {160: {GREETING: '',
 ...
 166: {QUEST: 'Nice work defeating those Cogs.\x07You know, the Cogs come in five different types.\x07They are Lawbots, Cashbots, Sellbots, Bossbots, and Paintbots.\x07You can tell them apart by their coloring and their name labels.\x07For practice go defeat 4 Bossbots.'},
 167: {QUEST: 'Nice work defeating those Cogs.\x07You know, the Cogs come in five different types.\x07They are Lawbots, Cashbots, Sellbots, Bossbots, and Paintbots.\x07You can tell them apart by their coloring and their name labels.\x07For practice go defeat 4 Lawbots.'},
 168: {QUEST: 'Nice work defeating those Cogs.\x07You know, the Cogs come in five different types.\x07They are Lawbots, Cashbots, Sellbots, Bossbots, and Paintbots.\x07You can tell them apart by their coloring and their name labels.\x07For practice go defeat 4 Sellbots.'},
 169: {QUEST: 'Nice work defeating those Cogs.\x07You know, the Cogs come in five different types.\x07They are Lawbots, Cashbots, Sellbots, Bossbots, and Paintbots.\x07You can tell them apart by their coloring and their name labels.\x07For practice go defeat 4 Cashbots.'},
 170: {QUEST: 'Nice work, now you know the difference between the 5 types of Cogs.\x07I think you are ready to start training for your third gag track.\x07Go talk to _toNpcName_ to choose your next gag track - he can give you some expert advice._where_'},
 171: {QUEST: 'Nice work, now you know the difference between the 5 types of Cogs.\x07I think you are ready to start training for your third gag track.\x07Go talk to _toNpcName_ to choose your next gag track - he can give you some expert advice._where_'},
 172: {QUEST: 'Nice work, now you know the difference between the 5 types of Cogs.\x07I think you are ready to start training for your third gag track.\x07Go talk to _toNpcName_ to choose your next gag track - she can give you some expert advice._where_'},
 175: {GREETING: '',
...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Toontown Evolution rules.",
...
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown Evolution product.'
...
SuitBigWig = 'Big Wig'
SuitMoltenMan = 'Molten Man'
SuitPinkSmasher = 'Pink Smasher'
SuitSoulCrusher = 'Soul Crusher'
SuitMiserySpreader = 'Misery Spreader'
SuitRageinator = 'Rageinator'
SuitAdvertiser = 'Advertiser'
SuitBookManager = 'Book Manager'
SuitMasterSalesman = 'Master Salesman'
...
SuitMoltenManS = 'a Molten Man'
SuitPinkSmasherS = 'a Pink Smasher'
SuitSoulCrusherS = 'a Soul Crusher'
SuitMiserySpreaderS = 'a Misery Spreader'
SuitRageinatorS = 'a Rageinator'
SuitAdvertiserS = 'a Advertiser'
SuitBookManagerS = 'a Book Manager'
SuitMasterSalesmanS = 'a Master Salesman'
...
SuitMoltenManP = 'Molten Men'
SuitPinkSmasherP = 'Pink Smashers'
SuitSoulCrusherP = 'Soul Crushers'
SuitMiserySpreaderP = 'Misery Spreaders'
SuitRageinatorP = 'Rageinators'
SuitAdvertiserP = 'Advertisers'
SuitBookManagerP = 'Book Managers'
SuitMasterSalesmanP = 'Master Salesmen'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Toontown Evolution.",
 ...
 'SongAndDance': ['No song can exist without a dance!',
          "This is the best dance you've ever seen toon!",
          "I'm unstoppable!",
          "I'll show you my moves!",
          "You wish that you were as good as me!"],
...
FriendInviterPlayerFriendInfo = 'A friend across the Toontown Evolution network'
...
LauncherStartingMessage = "Starting Toontown Evolution... "
...
LauncherConnectProxyAttempt = 'Connecting to Toontown Evolution: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Toontown Evolution: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Toontown Evolution...'
LauncherCreatingDownloadDb = 'Updating Toontown Evolution...'
LauncherDownloadClientFileList = 'Updating Toontown Evolution...'
LauncherFinishedDownloadDb = 'Updating Toontown Evolution... '
LauncherStartingGame = 'Starting Toontown Evolution...'
LauncherRecoverFiles = 'Updating Toontown Evolution. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Toontown Evolution...'
...
MusicTtiTheme = 'The Toontown Evolution Theme'
...
QuestScriptTutorialBlocker_7 = "It's called the SpeedChat Plus button. You need to turn on Speedchat Plus in your Account Manager on the Toontown Evolution Website to use it."
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Toontown Evolution folder on your computer.',
               ...
               'You never need to save your Toontown progress. The Toontown Evolution servers continually save all the necessary information.',
 ...
 TIP_STREET: ('There are five types of Cogs: Lawbots, Cashbots, Sellbots, Bossbots, and Paintbots.',
...
CogdoFlyingGameLegalEagleAttacking = 'Incoming Legal Eagle!'
CogdoFlyingGamePickUpAPropeller = 'You need a propeller to fly!'
CogdoFlyingGamePressCtrlToFly = "Press the 'Ctrl' key to fly up!"
CogdoFlyingGameYouAreInvincible = 'Red Tape is protecting you!'
CogdoFlyingGameTimeIsRunningOut = 'Hurry! Time is running out!'
...
CogdoFlyingGameTakingMemos = 'Oh No! The Legal Eagles took all your memos!'
...
CogdoExecutiveSuiteToonThankYouLawbot = "Thanks for rescuing me!\nYou found the missing jellybeans! Here take some! I added 500 jellybeans to your bank account!"
CogdoExecutiveSuiteToonBye = 'See you later!'
CogdoBarrelRoomTitle = 'The Stomper Room'
CogdoBarrelRoomIntroDialog =  "Good work, Toons! You have haulted the Stomp-O-Matic 6000 and are now able to collect some of the stolen laff barrels, but make sure to hurry before the cogs come!"
